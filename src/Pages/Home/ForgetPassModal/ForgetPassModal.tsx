      ...
      >
        <div className={S.close_wrapper}>
          <FontAwesomeIcon
            className="pointer"
            icon={faClose}
            onClick={() => !isSubmitting && setForgetPassModalOpen(false)}
          />
        </div>
        <h3>Forget Password</h3>
        <p className={S.p}>
          Enter the email that you used to create an account, and we will send
          an email to reset your account password.
        </p>
        <input
