    ...
    <div className={S.container}>
      {!showMessage && (
        <div className={S.success_gif_cont}>
          <img className={S.success_gif} src={successGIF} alt="loading gif" />
        </div>
      )}
      ...
      {showMessage && (
        ...
        >
          ...
          <div className={S.box}>
            ...
            <p>
              After completing the verification you can Login to your account .
            </p>
            <Link to="/" style={{ textDecoration: "none" }}>
              <button className={`btn ${S.login_btn}`}>Login</button>
            </Link>
          </div>
        </motion.div>
      )}
